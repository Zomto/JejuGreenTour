...
CREATE TABLE SUB_ACCOM (
    ...
    , DAYUSE_PRICE VARCHAR(30)
    , RESERVATION_PRICE VARCHAR(30)
    , SOLD_OUT VARCHAR2(3) DEFAULT 'N'
);



CREATE TABLE SUB_ACCOM_CATEGORY(
    SUB_ACCOM_CATE VARCHAR2(50) PRIMARY KEY
    , SUB_CATE_NAME VARCHAR2(30) -- 1.풀빌라 2.일반 3.
);
