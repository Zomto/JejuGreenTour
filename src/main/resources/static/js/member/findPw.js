...
function changePassword() {
    ...
    const confirmPassword = document.querySelector('#memberPwCheck').value;

    if (memberId === '') {
        inputInvalidate('.err-div', '아이디를 입력해주세요!');
        return;
    } else if (memberPw === '') {
        inputInvalidate('.err-div', '새 비밀번호를 입력해주세요!');
        return;
    } else if (memberPwCheck === '') {
